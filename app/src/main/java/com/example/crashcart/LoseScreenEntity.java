...
public class LoseScreenEntity implements EntityBase{
    ...
    public static LoseScreenEntity Create()
    {
        LoseScreenEntity result = new LoseScreenEntity();
